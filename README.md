...
3. vote one the candidate , after voting , user cant vote again 
4. there is a route which shows list of candidate and there live vote counts sorted by their vote count 
...
User Authentication:
 ...
 /login: POST Log in to an existing account. [ aadhar card number + password 1]
